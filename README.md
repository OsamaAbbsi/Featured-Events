# Featured-Events
Evently — Featured Events Page | Case study submission for Dynamics 360 Web Development Internship. A responsive single-page website built with HTML5, CSS3 &amp; Vanilla JS featuring dynamic event cards, live search filtering, mobile-friendly layout, and a custom editorial design system.
Technologies & Tools
| Layer | Choice |
|-------|--------|
| Markup | HTML5 |
